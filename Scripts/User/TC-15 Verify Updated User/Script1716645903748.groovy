...
WS.verifyElementPropertyValue(res, 'firstName', 'bbb')

WS.verifyElementPropertyValue(res, 'lastName', 'ccc')

WS.verifyElementPropertyValue(res, 'email', 'www@eee.com')

WS.verifyElementPropertyValue(res, 'password', 'qwerty')

WS.verifyElementPropertyValue(res, 'phone', '54321')

WS.verifyElementPropertyValue(res, 'userStatus', '2')
